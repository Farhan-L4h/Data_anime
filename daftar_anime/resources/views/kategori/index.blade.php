...
<body style="background: lightgray">
     ...
     <nav>
        <ul>
            ...
            <li><a href="{{ route('anime.index') }}">LIST ANIME POPULER</a></li>
...
<body style="background: lightgray">
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4" style='color: Black;'> <b> LIST KATEGORI</b></h3>
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('kategori.create') }}" class="btn btn-md btn-success mb-3">TAMBAH LIST</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('kategori.destroy', $kategori->id) }}" method="POST">
                                            <a href="{{ route('anime.index')}}" class="btn btn-sm btn-dark">DETAILS</a>
